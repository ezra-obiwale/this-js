...
this.__.callable(callback).call(this);components.each(function(){var __this=_this._(this);if(__this.attr('this-url')){internal.fullyFromURL.call(_this,'component',__this.attr('this-url'),function(data){internal.loadComponent.call(_this,__this,_this._(data),callback);},function(){_this.__.callable(callback).call(_this);});}

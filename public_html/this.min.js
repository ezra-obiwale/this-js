...
else{internal.loadComponents.call(this);internal.loadCollections.call(this,replaceInState);internal.loadModels.call(this,replaceInState);internal.loadForms.call(this);this.page.attr('this-loaded','');internal.pageLoaded.call(this,replaceInState);}},pageLoaded:function(replaceState){if(!this.__proto__.collections&&!this.__proto__.models&&!this.__proto__.components){var _this=this;this.container.find('[this-inline-code]').each(function(){var __this=_this._(this),tags=internal.parseBrackets.call(_this,'<','>',__this.html()),content=__this.html();_this.__.forEach(tags,function(i,v){content=content.replace(v,'&lt;'+v.substr(1,v.length-2)+'&gt;');});__this.replaceWith(_this._('<code />').html(content));});this.container.find('[this-block-code]').each(function(){var __this=_this._(this),tags=internal.parseBrackets.call(_this,'<','>',__this.html()),content=__this.html();_this.__.forEach(tags,function(i,v){content=content.replace(v,'&lt;'+v.substr(1,v.length-2)+'&gt;');});__this.replaceWith(_this._('<pre />').html(content)).innerWrap('<code />');});delete this.firstPage;this.page.trigger('page.loaded');internal.saveState.call(this,replaceState);}

    ...
    ThisApp.prototype = {
                ...
                if (this.page.attr('this-url')) {
                    this.request(this.page, function (data) {
                        ...
                        _this.loadComponents()
                                .loadCollections(replaceState)
                                .loadModels(replaceState)
                                .loadForms(replaceState)
                                .pageLoaded(replaceState);
                    }, {}, 'text');
                }
                else {
                    this.loadComponents()
                    ...
                    .each(function () {
                        ...
                        if (!_this.__.contains(ignore, 'collection.' + __this.attr('this-id')) && cached
                            ...
                            _this.request(this, function (data) {
                                --_this.collections;
                                _this.loadData(this, data, content, false, save);
                                _this.pageLoaded(replaceState);
                            }, data);
                        }
                    }).length;
        ...
        loadModels: function (replaceState) {
            var _this = this,
                    ...
                    .each(function () {
                        _this.loadModel(this, false, replaceState);
                    }).length;
            this.models += models;
            return this;
        },
            ...
            if (this.__.isArray(data) || model === false) {
                ...
                this.__.forEach(data, function (index, model) {
                    ...
                    if (!_this.__.contains(ignore, 'collection.' + container.attr('this-id'))
                            && filter && !eval(filter))
                        return;
                    _this.doLoad(container, model, content, variables);
                });
                if (type === 'collection') {
